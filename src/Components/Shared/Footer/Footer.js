        ...
        <div className="row">
          <div className="contect col-lg-3 col-md-6 col-12  order-lg-1 ">
            <h3>
              ...
              <span className="ms-1">GOT QUESTIONS ?</span>
            </h3>
            <p>(001) 2345-6789</p>
            <p>(001) 5823-6530</p>
            <p>
          ...
          <div className="col-lg-3 col-md-6 col-12  order-lg-1 ">
            ...
            <li>
              <img
                src="https://i.ibb.co/JnbCY6t/PROD1-500x.png"
                alt="payment"
                className="payment mb-2 mt-2"
              />
            </li>
            <li>
              <img
                src="https://i.ibb.co/fHWBpR7/payment.png"
                alt="Secured"
                className="secured mt-2"
              />
            </li>
          </div>
        </div>
